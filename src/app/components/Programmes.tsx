  ...
  return (
    <div className="w-full">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8 hover:shadow transition-shadow">
            <div className="flex items-start gap-4">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-amber-100 text-amber-700">
                <GraduationCap className="size-5" />
              </div>
              <div>
                <h2 className="text-2xl text-gray-900 mb-2">PhD in English</h2>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8 hover:shadow transition-shadow">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h2 className="text-2xl text-gray-900 mb-2">Undergraduate and Postgraduate Courses</h2>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-amber-50 border border-amber-100 rounded-lg p-8">
          ...
          <div className="mt-6">
            <h3 className="text-2xl text-gray-900 mb-4">Areas of Research</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={i} className="bg-slate-50 border border-gray-100 rounded-lg p-4 hover:shadow-lg hover:-translate-y-1 transition-transform transition-shadow">
          ...
          <div className="mt-8 grid md:grid-cols-2 gap-6">
            <div className="bg-amber-50 border border-amber-100 rounded-lg p-6 border-l-4 border-amber-200 pl-5 hover:shadow transition-shadow">
              <h4 className="text-lg text-gray-900 mb-2">Eligibility</h4>
            ...
            <div className="bg-amber-50 border border-amber-100 rounded-lg p-6 border-l-4 border-amber-200 pl-5 hover:shadow transition-shadow">
              <h4 className="text-lg text-gray-900 mb-2">Admission</h4>
              <p className="text-gray-700">
                ...
                <a href="http://www.iiitdm.ac.in/admissions" target="_blank" rel="noreferrer" className="text-sky-600 hover:underline">www.iiitdm.ac.in/admissions</a>.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-sky-50 border border-sky-100 rounded-lg p-8">
          ...
          <div className="mt-6">
            <h3 className="text-2xl text-gray-900 mb-4">Compulsory Courses</h3>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-slate-50 border border-slate-100 rounded-lg p-6 hover:shadow-lg hover:-translate-y-1 transition-transform transition-shadow">
                <h4 className="text-lg text-gray-900 mb-2">English for Communication</h4>
                <p className="text-gray-700">Semester I — all B.Tech students</p>
              </div>

              <div className="bg-slate-50 border border-slate-100 rounded-lg p-6 hover:shadow-lg hover:-translate-y-1 transition-transform transition-shadow">
                <h4 className="text-lg text-gray-900 mb-2">Technical Writing and Communication</h4>
          ...
          <div className="mt-8">
            <h3 className="text-2xl text-gray-900 mb-4">Elective Courses</h3>
            <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-6">
              {[
                ...
                <div key={i} className="bg-slate-50 border border-slate-100 rounded-lg p-4 hover:shadow-lg hover:-translate-y-1 transition-transform transition-shadow">
                  <h4 className="text-sm font-semibold text-gray-900">{course}</h4>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white/60 bg-gradient-to-r from-white to-sky-50 border border-gray-200 rounded-lg p-8">
          <h3 className="text-2xl text-gray-900 mb-4">Curriculum Information</h3>
          <p className="text-gray-700">
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-lg p-8 text-center text-white" style={{ background: "linear-gradient(90deg, rgba(15,23,42,1) 0%, rgba(30,41,59,1) 100%)" }}>
